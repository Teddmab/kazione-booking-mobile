...
const styles = StyleSheet.create({
  ...
  openBadgeText: { ...TYPOGRAPHY.caption, color: '#FFFFFF', fontWeight: '700' },
  section: { padding: SPACING.md, gap: SPACING.sm },
  sectionTitle: { ...TYPOGRAPHY.h2, color: COLORS.text, marginBottom: SPACING.xs },
  categoryLabel: { ...TYPOGRAPHY.label, color: COLORS.orange, marginTop: SPACING.sm },
  bodyText: { ...TYPOGRAPHY.body, color: COLORS.textSecondary },
  readMore: { ...TYPOGRAPHY.label, color: COLORS.orange, marginTop: SPACING.xs },
